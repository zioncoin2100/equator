...
using JavaScript and `EventSource`.  We will eschew using [`js-zion-sdk`](https://github.com/zion/js-zion-sdk), the
...
> If you need a reliable streaming connection please use our [SDK](https://github.com/zion/js-zion-sdk).
