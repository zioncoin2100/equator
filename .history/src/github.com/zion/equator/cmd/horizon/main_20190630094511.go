...
func init() {
	...
	viper.BindEnv("zion-core-db-url", "STELLAR_CORE_DATABASE_URL")
	viper.BindEnv("zion-core-url", "STELLAR_CORE_URL")
...
func initConfig() {
	...
	if viper.GetString("zion-core-db-url") == "" {
		log.Fatal("Invalid config: zion-core-db-url is blank.  Please specify --zion-core-db-url on the command line or set the STELLAR_CORE_DATABASE_URL environment variable.")
	}

	if viper.GetString("zion-core-url") == "" {
		log.Fatal("Invalid config: zion-core-url is blank.  Please specify --zion-core-url on the command line or set the STELLAR_CORE_URL environment variable.")
	}
