...
clientData:
  laboratoryUrl: http://zionc.info/laboratory/#explorer?resource=data&endpoint=for_account
---
...
```sh
curl "https://equator-testnet.zion.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/data/user-id"
```
