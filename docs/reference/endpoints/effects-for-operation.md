...
clientData:
  laboratoryUrl: http://zionc.info/laboratory/#explorer?resource=effects&endpoint=for_operation
---
...
```sh
curl "https://equator-testnet.zion.org/operations/77309415424/effects"
```
