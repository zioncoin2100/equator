...
clientData:
  laboratoryUrl: http://zionc.info/laboratory/#explorer?resource=transactions&endpoint=for_ledger
---
...
```sh
curl "https://equator-testnet.zion.org/ledgers/69859/transactions"
```
