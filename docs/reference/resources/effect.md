...
directly reflected in the [ledger](http://zionc.info/developers/learn/concepts/ledger.html) or [history](https://github.com/zion2100/zion-core/blob/master/docs/history.md), as [transactions](http://zionc.info/developers/learn/concepts/transactions.html) and [operations](http://zionc.info/developers/learn/concepts/operations.html) are.
