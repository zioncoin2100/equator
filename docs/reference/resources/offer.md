...
Accounts on the Zion network can make [offers](http://zion.org/developers/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://zion.org/developers/learn/concepts/list-of-operations.html) operation.

Equator only returns offers that belong to a particular account.  When it does, it uses the following format:
...
| selling     | [Asset](http://zion.org/developers/learn/concepts/assets.html)           | The Asset this offer wants to sell.                      |
| buying     | [Asset](http://zion.org/developers/learn/concepts/assets.html) | The Asset this offer wants to buy. |
