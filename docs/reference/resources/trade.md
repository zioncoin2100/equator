...
Trades can also be caused by successful [path payments](http://zionc.info/developers/learn/concepts/exchange.html), because path payments involve fulfilling offers.
