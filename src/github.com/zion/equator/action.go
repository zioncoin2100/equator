...
import (
	...
	"github.com/zion/equator/actions"
...
// Action is the "base type" for all actions in equator.  It provides
...
// CoreQ provides access to queries that access the zion core database.
...
func (action *Action) HistoryQ() *history.Q {
	if action.hq == nil {
		action.hq = &history.Q{Session: action.App.EquatorSession(action.Ctx)}
	}
