...
// GetAddress retrieves a zion address.  It confirms the value loaded is a
// valid zion address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a zion
...
// the string at the provided name in accordance with the zion client
// conventions
