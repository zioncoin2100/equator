...
// reading rows from a Zion Core db
package core
...
// Offer is row of data from the `offers` table from zion-core
type Offer struct {
...
// Q is a helper struct on which to hang common queries against a zion
// core database.
type Q struct {
	*db.Session
}
...
// Signer is a row of data from the `signers` table from zion-core
type Signer struct {
	Accountid string
	Publickey string
	Weight    int32
...
// Transaction is row of data from the `txhistory` table from zion-core
...
// TransactionFee is row of data from the `txfeehistory` table from zion-core
...
// Trustline is a row of data from the `trustlines` table from zion-core
...
// zion-core database this ingestion system is communicating with.  Equator,
...
// database.
//
// Due to the design of zion-core, ledger 1 will _always_ be in the database,
