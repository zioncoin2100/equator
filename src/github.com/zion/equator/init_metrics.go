...
func initDbMetrics(app *App) {
	...
	app.equatorConnGauge = metrics.NewGauge()
	...
	app.metrics.Register("zion_core.latest_ledger", app.coreLatestLedgerGauge)
	app.metrics.Register("zion_core.elder_ledger", app.coreElderLedgerGauge)
	app.metrics.Register("history.open_connections", app.equatorConnGauge)
	app.metrics.Register("zion_core.open_connections", app.coreConnGauge)
...
func init() {
	...
	appInit.Add("db-metrics", initDbMetrics, "metrics", "equator-db", "core-db")
