...
// Web contains the http server related fields for equator: the router,
// rate limiter, etc.
type Web struct {
	router      *web.Mux
...
// initWebMiddleware installs the middleware stack used for equator onto the
// provided app.
...
// initWebActions installs the routing configuration of equator onto the
