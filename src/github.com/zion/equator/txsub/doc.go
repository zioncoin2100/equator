// Package txsub provides the machinery that equator uses to submit transactions to
// the zion network and track their progress.  It also helps to hide some of the
