...
// be submitted to the backing zion-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to zion-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to zion-core
