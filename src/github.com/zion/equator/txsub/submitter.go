...
// that submits directly to the zion-core at `url` using the http client
// `h`.
...
// coreSubmissionResponse is the json response from zion-core's tx endpoint
...
// submits directly to the configured zion-core instance using the
...
// Submit sends the provided envelope to zion-core and parses the response into
// a SubmissionResult
